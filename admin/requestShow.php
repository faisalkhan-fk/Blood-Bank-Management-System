  ...
  <div class="container">
        ...
        <p class="text-center text-danger h1">Request Panel</p>
            <table class="table">
                ...
                $sql5 = "select * from request order by id desc";
                ...
                if (mysqli_num_rows($resultG) > 0) {
                    ...
                    while ($rowG = mysqli_fetch_assoc($resultG)) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $rowG['bloodrequire']; ?></td>
                            <td><?php echo $rowG['message']; ?></td>
                            <td><?php echo $rowG['requestDate']; ?></td>
                            <td><a href="deleteRequest.php?act=<?php echo $rowG['id']?>" class="btn btn-danger">Delete</a>
                        </tr> 
                        <?php
                        $n++;
                    }
